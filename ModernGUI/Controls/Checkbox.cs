...
namespace ModernGUI.Controls
{
    public class Checkbox : CheckBox, IControl
    {
        ...
        protected override void OnPaint(PaintEventArgs pevent)
        {
            ...
            using (var checkmarkPath = ModernGUI.Shared.Drawing.CreateRoundRect(_boxOffset, _boxOffset, 17, 17, 1f))
            {
                var brush2 = new SolidBrush(ModernGUI.Shared.Drawing.BlendColor(Parent.BackColor, Enabled ? SkinManager.GetCheckboxOffColor() : SkinManager.GetCheckBoxOffDisabledColor(), backgroundAlpha));
