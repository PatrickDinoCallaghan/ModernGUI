...
{
    public class FlatButton : Button, IControl
    {
        [Browsable(false)]
        public int Depth { get; set; }
        [Browsable(false)]
        public ModernGUI.SkinManager SkinManager => ModernGUI.SkinManager.Instance;
        [Browsable(false)]
        ...
        public override string Text
        {
            ...
            {
                base.Text = value;
                _textSize = CreateGraphics().MeasureString(value.ToUpper(), SkinManager.OpenSans_MEDIUM_10);
                if (AutoSize)
                    Size = GetPreferredSize();
                Invalidate();
            }
